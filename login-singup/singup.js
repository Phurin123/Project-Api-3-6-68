// การแสดง/ซ่อนไอคอนสำหรับรหัสผ่าน
    document.getElementById('password').addEventListener('input', function () {
        ...
        eyeIcon.style.display = passwordField.value ? 'block' : 'none'; // แสดงไอคอนเมื่อมีการกรอกข้อมูล
    });
...
// การแสดง/ซ่อนไอคอนสำหรับ Confirm Password
    document.getElementById('confirmPassword').addEventListener('input', function () {
        ...
        eyeIcon.style.display = confirmPasswordField.value ? 'block' : 'none'; // แสดงไอคอนเมื่อมีการกรอกข้อมูล
    });
